...
export class Flipper {
    ...
    private setDimensions = (): void => {
        this.setWidthOfOnePiece(
            isNaN(spriteInputWidth.valueAsNumber) ? 0 : spriteInputWidth.valueAsNumber
        );
        this.setHeightOfOnePiece(
            isNaN(spriteInputHeight.valueAsNumber) ? 0 : spriteInputHeight.valueAsNumber
        );
        this.setNumCols(
            spriteSheetImage.width / this.getWidthOfOnePiece()
        );
        this.sliceImage();
    };
